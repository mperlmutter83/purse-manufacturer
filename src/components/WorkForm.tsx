...
export default function WorkForm() {
  ...
  // Spam-gate metadata — initialized after mount to keep render pure
  ...
  if (status === 'success') {
    return (
      <div className="bg-teal/10 border border-teal rounded-md p-6 text-center">
        <p className="text-3xl">🎉</p>
        <h3 className="mt-3 text-2xl text-navy font-bold">You&apos;re on the list!</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="experience" className="block text-sm font-medium text-navy mb-1">
          Experience
        </label>
        <select
          id="experience"
