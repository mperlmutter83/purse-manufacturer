...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Launching a handbag line is exciting-but choosing the right purse manufacturer can make or break your brand. From product quality to profit margins, your manufacturer plays a huge role in your success. Whether you're...",
...
const publishedAtMap: Record<string, string> = {
  'how-to-choose-the-right-purse-manufacturer-for-your-brand': '2026-05-02',
};

export function getAllPosts(): (BlogPost & { publishedAt: string })[] {
  return blogPosts.map(post => ({
    ...post,
    publishedAt: publishedAtMap[post.slug] ?? post.date,
  }));
}
